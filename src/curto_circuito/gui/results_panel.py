...
_MT_THRESHOLD_KV = 1.0   # acima deste valor → MT
...
_COLOR_MT_BG  = QColor("#D6E4F0")   # azul claro — linha MT
_COLOR_BT_BG  = QColor("#D5F5E3")   # verde claro — linha BT
_COLOR_MT_LVL = QColor("#1A5276")   # texto do nível MT
_COLOR_BT_LVL = QColor("#1E8449")   # texto do nível BT
...
class ResultsPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.table.horizontalHeader().setSectionResizeMode(
            1, QHeaderView.ResizeMode.Stretch   # coluna "Barra" estica
        )
        self.table.setEditTriggers(QTableWidget.EditTrigger.NoEditTriggers)
        self.table.setAlternatingRowColors(False)   # cor manual por nível
    ...
    def show_results(self, results: StudyResults) -> None:
        ...
        # Ordena: MT primeiro, depois BT; dentro de cada grupo mantém ordem BFS
        ...
        for row, br in enumerate(ordered):
            ...
            nivel = "MT" if is_mt else "BT"
            bg = _COLOR_MT_BG if is_mt else _COLOR_BT_BG
            fg_nivel = _COLOR_MT_LVL if is_mt else _COLOR_BT_LVL
