...
class TransformerDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self.sb_sn = QDoubleSpinBox(); self.sb_sn.setRange(0.001, 9999); self.sb_sn.setSuffix(" MVA"); self.sb_sn.setDecimals(3); self.sb_sn.setValue(0.630)
        self.sb_un1 = QDoubleSpinBox(); self.sb_un1.setRange(0.1, 500); self.sb_un1.setSuffix(" kV"); self.sb_un1.setDecimals(2); self.sb_un1.setValue(13.8)
        self.sb_un2 = QDoubleSpinBox(); self.sb_un2.setRange(0.1, 500); self.sb_un2.setSuffix(" kV"); self.sb_un2.setDecimals(2); self.sb_un2.setValue(0.38)
        self.sb_uk = QDoubleSpinBox(); self.sb_uk.setRange(0.1, 20); self.sb_uk.setSuffix(" %"); self.sb_uk.setDecimals(2); self.sb_uk.setValue(4.0)
        self.sb_pk = QDoubleSpinBox(); self.sb_pk.setRange(0, 9999); self.sb_pk.setSuffix(" kW"); self.sb_pk.setDecimals(2); self.sb_pk.setValue(6.0)
        self.cb_vg = QComboBox()
        self.cb_vg.addItems(["Dyn1", "Dyn11", "YNyn0", "Yzn11", "Dd0"])
